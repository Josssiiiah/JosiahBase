    ...
    <div className="rounded-div my-12 py-8">
      ...
      <div className="grid md:grid-cols-2 gap-8">
        ...
        <div>
          ...
          <div className="flex justify-between py-4">
            <div>
              <p className="flex justify-between py-4">Price Change (30d)</p>
              {coin.market_data ? (
                <p>
            ...
            <div>
              <p className="flex justify-between py-4">Price Change (60d)</p>
              {coin.market_data ? (
                <p>
            ...
            <div>
              <p className="flex justify-between py-4">Price Change (1y)</p>
              {coin.market_data ? (
